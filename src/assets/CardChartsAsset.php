...
class CardChartsAsset extends AssetBundle
{
    ...
    public $css = [
        ...
        'app-assets/css/core/colors/palette-gradient.min.css',
        'app-assets/css/pages/card-charts.min.css',
    ...
    public $js = [
        ...
        'app-assets/vendors/js/charts/chartist-plugin-tooltip.js',
        'app-assets/vendors/js/charts/chart.min.js',
        'app-assets/js/core/app-menu.min.js',
        'app-assets/js/core/app.min.js',
        'app-assets/js/scripts/customizer.min.js',
        'app-assets/js/scripts/cards/card-charts.min.js',
