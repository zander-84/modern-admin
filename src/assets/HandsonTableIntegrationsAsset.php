...
class HandsonTableIntegrationsAsset extends AssetBundle
{
    ...
    public $js = [
        ...
        'app-assets/vendors/js/tables/handsontable/languages.min.js',
        'app-assets/vendors/js/tables/handsontable/chroma.min.js',
        'app-assets/js/core/app-menu.min.js',
        'app-assets/js/core/app.min.js',
        'app-assets/js/scripts/customizer.min.js',
        'app-assets/js/scripts/tables/handsontable/handsontable-integrations.js',
