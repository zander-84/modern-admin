...
class DtExtensionsButtonsHtml5DataExportAsset extends AssetBundle
{
    ...
    public $js = [
        ...
        'app-assets/js/scripts/tables/datatables-extensions/datatable-button/datatable-html5.js',
