...
$bundle = zander84\modernadmin\assets\ModernAsset::register($this);
 ...
 \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
        \zander84\modernadmin\assets\LayoutLightAsset::class,
    ]
]);
zander84\modernadmin\assets\MultitabsAsset::register($this);
            ...
            init: [                                    //需要在初始加载的tab
                {
                    ...
                    title: 'Home',                         //标题（可选），没有则显示网址 app MENU_DASHBOARD
                    iframe: true,
                    content: '',                        //html内容，如果设定此值，下面的URL设定则无效
                    url:  '/modern/index?id=index2'                           //链接
                }
