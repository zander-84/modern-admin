...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\FormLayoutStripedRowsAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Striped Row Forms</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="form-layout-striped-rows.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="form-layout-striped-rows.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="form-layout-striped-rows.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="form-layout-striped-rows.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-text">
<p>Add <code>.striped-rows</code> to form tag to add striped rows.
                        In this example icons are used with form controls to show
                        the striped rows functionality.</p>
</div>
<form class="form form-horizontal striped-rows form-bordered">
<div class="form-body">
<div class="form-group row">
...
<div class="card-text">
<p>Add <code>.striped-rows</code> to form tag to add striped rows.
                        In this example centered card is used to show the striped
