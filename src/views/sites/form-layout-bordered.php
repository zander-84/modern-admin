...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\FormLayoutBorderedAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Bordered Forms</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="form-layout-bordered.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="form-layout-bordered.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="form-layout-bordered.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="form-layout-bordered.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<input class="custom-control-input" name="customer" type="radio"/>
<span class="custom-control-indicator"></span>
<span class="custom-control-description ml-0">Yes</span>
</label>
<label class="d-inline-block custom-control custom-radio">
<input checked="" class="custom-control-input" name="customer" type="radio"/>
<span class="custom-control-indicator"></span>
