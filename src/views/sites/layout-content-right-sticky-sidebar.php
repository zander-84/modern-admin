...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutContentRightStickySidebarAsset::class,
    ]
]);
?>
...
<a class="btn btn-primary" href="layout-content-right-sticky-sidebar.html#">Button</a>
<!-- /Card sample -->
<hr/>
...
<div class="media">
<a class="media-left pr-1" href="layout-content-right-sticky-sidebar.html#">
...
<h3 class="content-header-title mb-0 d-inline-block">Content Right Sticky Sidebar</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="layout-content-right-sticky-sidebar.html#">Page Layouts</a>
</li>
<li class="breadcrumb-item active">Content Right Sidebar Sticky
                  </li>
</ol>
</div>
</div>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-content-right-sticky-sidebar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-content-right-sticky-sidebar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-content-right-sticky-sidebar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-content-right-sticky-sidebar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Content layout with right sticky sidebar provides more navigations
...
<div class="card-body">
<div class="card-text">
<p>This table contains all classes related to the content right sticky
                    sidebar layout. This is a custom layout classes for content right
...
<div class="card-body">
<div class="card-text">
<p>This section contains HTML Markup to create 3 column right sticky
                    sidebar layout. You need to add the <code>.content-right-sidebar</code>                    class in the <code>&lt;body&gt;</code> tag as show in below markup
                    on line no 4. This layout has a navigation, content and right
                    sidebar sections with common header &amp; footer.</p>
<ul>
<li>
<span class="text-bold-600">Line no 27:</span> Contain the <code>.content-left</code> class
                      for adjusting content section in left side.</li>
<li>
...
<li>
<span class="text-bold-600">Line no 34:</span> Contain the <code>.sidebar-sticky</code>                      class, that will make the right sidebar sticky.</li>
</ul>
...
<p>To generate content right sticky sidebar layout page or template,
                    you need to use following PUG code.</p>
<ul>
<li>
<span class="text-bold-600">Line no 20-22:</span> You need to set <code>contentLayout</code>                      variable value as <code>'content-right-sidebar'</code> in <code>pageConfig</code>                      block.</li>
<li>
...
<span class="text-bold-600">Line no 28-29:</span> <code>content</code> block has content
                      section html file included <code>include ../contents/layout-content-right-sticky-sidebar.html</code>,
...
<p>If you want to use this layout on page level you need to define
                    ...
                    content right sticky sidebar <code>layout-content-right-sticky-sidebar.pug</code>,
                    however you can use it on template level but it will generate
                    whole template as a content right sticky sidebar.</p>
<pre class="language-pug" data-line="20-22, 28-29, 31-32" data-line-offset="11">
                ...
                append content
                	include ../contents/layout-content-right-sticky-sidebar.html
