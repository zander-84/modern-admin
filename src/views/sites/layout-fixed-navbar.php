...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutFixedNavbarAsset::class,
    ]
]);
?>
...
<li class="breadcrumb-item"><a href="layout-fixed-navbar.html#">Page Layouts</a>
</li>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-fixed-navbar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-fixed-navbar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-fixed-navbar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-fixed-navbar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>The fixed navbar layout has a fixed navbar and static navigation
                  menu and footer. Only navbar section is fixed to user. In this
...
<ul>
<li>
<span class="text-bold-600">Line no 20-21:</span> Set navbar fixed class to <code>navbarPosition</code>                    variable value as <code>'fixed-top'</code> in <code>navbarConfig</code>                    block.</li>
<li>
<span class="text-bold-600">Line no 28-29:</span> <code>content</code> block has content
                    section html file included <code>include ../contents/layout-fixed-navbar.html</code>,
...
<p>If you want to use this layout on page level you need to define it
                  ...
                  <code>layout-fixed-navbar.pug</code>, however you can use it on
                  template level but it will generate whole template as a fixed navbar
                  layout.
                </p>
<pre class="language-pug" data-line="20-21, 28-29" data-line-offset="11">
