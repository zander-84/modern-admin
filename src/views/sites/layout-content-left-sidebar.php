...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutContentLeftSidebarAsset::class,
    ]
]);
?>
...
<a class="btn btn-primary" href="layout-content-left-sidebar.html#">Button</a>
<!-- /Card sample -->
<hr/>
...
<div class="media">
<a class="media-left pr-1" href="layout-content-left-sidebar.html#">
...
<h3 class="content-header-title mb-0 d-inline-block">Content Left Sidebar</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="layout-content-left-sidebar.html#">Page Layouts</a>
</li>
<li class="breadcrumb-item active">Content Left Sidebar
                  </li>
</ol>
</div>
</div>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-content-left-sidebar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-content-left-sidebar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-content-left-sidebar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-content-left-sidebar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Content layout left sidebar provides more navigations options on
                    page level. For the larger screen this layout provides best usability.
                    This layout use the third column as a sidebar section.</p>
</div>
</div>
</div>
</section>
...
<div class="card-body">
<div class="card-text">
<p>This table contains all classes related to the content left sidebar
                    layout. This is a custom layout classes for content left sidebar
...
<div class="card-body">
<div class="card-text">
<p>This section contains HTML Markup to create 3 column left sidebar
                    layout. You need to add the <code>.content-left-sidebar</code>                    class in the <code>&lt;body&gt;</code> tag as show in below markup
                    on line no 4. This layout has a navigation, content and left
                    sidebar sections with common header &amp; footer.</p>
<ul>
<li>
<span class="text-bold-600">Line no 27:</span> Contain the and <code>.content-right</code>                      class for adjusting content section in right side.</li>
<li>
...
<p>To generate content left sidebar layout page or template, you need
                    to use following PUG code.</p>
<ul>
<li>
<span class="text-bold-600">Line no 20-21:</span> You need to set <code>contentLayout</code>                      variable value as <code>'content-left-sidebar'</code> in <code>pageConfig</code>                      block.</li>
<li>
<span class="text-bold-600">Line no 27-28:</span> <code>content</code> block has content
                      section html file included <code>include ../contents/layout-content-left-sidebar.html</code>,
...
<p>If you want to use this layout on page level you need to define
                    ...
                    content left sidebar <code>layout-content-left-sidebar.pug</code>,
                    however you can use it on template level but it will generate
                    whole template as a content left sidebar.</p>
<pre class="language-pug" data-line="20-21, 27-28, 30-31" data-line-offset="11">
              <code class="language-pug">
                block pageVars
                	...
                	- var activeMenu   = "layout-content-left-sidebar"
                ...
                append breadcrumbs
                	+breadcrumbs([{url:"index.html",name:"Home"},{url:"#",name:"Page Layouts"}, {name:"Content Left Sidebar"}])
