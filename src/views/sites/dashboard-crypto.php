...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\DashboardCryptoAsset::class,
    ]
]);
?>
...
<div class="row">
<div class="col-12">
<canvas class="height-75" id="btc-chartjs"></canvas>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-12">
<canvas class="height-75" id="eth-chartjs"></canvas>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-12">
<canvas class="height-75" id="xrp-chartjs"></canvas>
</div>
</div>
</div>
</div>
...
<div aria-multiselectable="true" id="accordionCrypto" role="tablist">
<div class="card collapse-icon accordion-icon-rotate">
<div class="card-header bg-info p-1 bg-lighten-1" id="heading31">
<a aria-controls="accordionBTC" aria-expanded="true" class="card-title lead white" data-parent="#accordionCrypto" data-toggle="collapse" href="dashboard-crypto.html#accordionBTC">BTC</a>
</div>
<div aria-expanded="true" aria-labelledby="heading31" class="card-collapse collapse show" id="accordionBTC" role="tabpanel">
<div class="card-content">
<div class="card-body p-0">
<div class="media-list list-group">
<div class="list-group-item list-group-item-action media p-1">
<a class="media-link" href="dashboard-crypto.html#">
...
<div class="card-header bg-info p-1 bg-lighten-1 my-1" id="heading32">
<a aria-controls="accordionETH" aria-expanded="false" class="card-title lead white collapsed" data-parent="#accordionCrypto" data-toggle="collapse" href="dashboard-crypto.html#accordionETH">ETH</a>
</div>
<div aria-expanded="false" aria-labelledby="heading32" class="card-collapse collapse" id="accordionETH" role="tabpanel">
<div class="card-content">
<div class="card-body p-0">
<div class="media-list list-group">
<div class="list-group-item list-group-item-action media p-1">
...
<div class="card-header bg-info p-1 bg-lighten-1" id="heading33">
<a aria-controls="accordionXRP" aria-expanded="false" class="card-title lead white collapsed" data-parent="#accordionCrypto" data-toggle="collapse" href="dashboard-crypto.html#accordionXRP">XRP</a>
</div>
<div aria-expanded="false" aria-labelledby="heading33" class="card-collapse collapse" id="accordionXRP" role="tabpanel">
<div class="card-content">
<div class="card-body p-0">
<div class="media-list list-group">
<div class="list-group-item list-group-item-action media p-1">
...
<div class="height-350 echart-container" id="btc-candlestick-control"></div>
</div>
</div>
</div>
</div>
...
<input autocomplete="off" checked="" id="option1" name="options" type="radio"/> Market
                    </label>
<label class="btn round btn-sm btn-outline-info">
<input autocomplete="off" id="option2" name="options" type="radio"/> Yours
                    </label>
</div>
</div>
</div>
...
<li class="nav-item">
<a aria-controls="limit" aria-expanded="true" class="nav-link active" data-toggle="tab" href="dashboard-crypto.html#limit" id="base-limit">Limit</a>
</li>
<li class="nav-item">
<a aria-controls="market" aria-expanded="false" class="nav-link" data-toggle="tab" href="dashboard-crypto.html#market" id="base-market">Market</a>
</li>
<li class="nav-item">
<a aria-controls="stop-limit" aria-expanded="false" class="nav-link" data-toggle="tab" href="dashboard-crypto.html#stop-limit" id="base-stop-limit">Stop Limit</a>
</li>
</ul>
<div class="tab-content px-1 pt-1">
<div aria-expanded="true" aria-labelledby="base-limit" class="tab-pane active" id="limit" role="tabpanel">
<div class="row">
...
<div class="col-md-9">
<input class="form-control" id="btc-limit-buy-price" name="btc-limit-buy-price" placeholder="$ 11916.9" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-limit-buy-amount">Amount</label>
<div class="col-md-9">
<input class="form-control" id="btc-limit-buy-amount" name="btc-limit-buy-amount" placeholder="0.026547 BTC" type="number"/>
</div>
</div>
<div class="form-group row">
<div class="col-md-3"></div>
<div class="col-md-9">
<button class="btn round btn-outline-secondary btn-sm" type="button">25%</button>
<button class="btn round btn-outline-secondary btn-sm" type="button">50%</button>
<button class="btn round btn-outline-secondary btn-sm" type="button">75%</button>
<button class="btn round btn-outline-secondary btn-sm" type="button">100%</button>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-limit-buy-total">Total</label>
<div class="col-md-9">
<input class="form-control" disabled="" id="btc-limit-buy-total" name="btc-limit-buy-total" placeholder="$ 318.1856" type="number"/>
</div>
</div>
<div class="form-actions pb-0">
<button class="btn round btn-success btn-block btn-glow" type="submit"> Buy BTC </button>
</div>
</div>
</form>
</div>
...
<div class="col-md-9">
<input class="form-control" id="btc-limit-sell-price" name="btc-limit-sell-price" placeholder="$ 11916.9" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-limit-sell-amount">Amount</label>
<div class="col-md-9">
<input class="form-control" id="btc-limit-sell-amount" name="btc-limit-sell-amount" placeholder="0.026547 BTC" type="number"/>
</div>
</div>
<div class="form-group row">
<div class="col-md-3"></div>
...
<div class="col-md-9">
<input class="form-control" disabled="" id="btc-limit-sell-total" name="btc-limit-sell-total" placeholder="$ 318.1856" type="number"/>
</div>
</div>
<div class="form-actions pb-0">
<button class="btn round btn-danger btn-block btn-glow" type="submit"> Sell BTC </button>
</div>
</div>
</form>
</div>
...
<div aria-labelledby="base-market" class="tab-pane" id="market">
<div class="row">
<div class="col-12 col-xl-6 border-right-blue-grey border-right-lighten-4 pr-2 p-0">
<div class="row my-2">
<div class="col-4">
...
<div class="col-md-9">
<input class="form-control" disabled="" id="btc-market-buy-price" name="btc-market-buy-price" placeholder="Market prise $" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-market-buy-amount">Amount</label>
<div class="col-md-9">
<input class="form-control" id="btc-market-buy-amount" name="btc-market-buy-amount" placeholder="0.026547 BTC" type="number"/>
</div>
</div>
<div class="form-group row">
<div class="col-md-3"></div>
...
<label class="col-md-3 col-form-label" for="btc-price">Price</label>
<div class="col-md-9">
<input class="form-control" disabled="" id="btc-market-sell-price" name="btc-market-sell-price" placeholder="Market prise $" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-market-sell-amount">Amount</label>
<div class="col-md-9">
<input class="form-control" id="btc-market-sell-amount" name="btc-market-sell-amount" placeholder="0.026547 BTC" type="number"/>
</div>
</div>
<div class="form-group row">
<div class="col-md-3"></div>
...
<div aria-labelledby="base-stop-limit" class="tab-pane" id="stop-limit">
<div class="row">
<div class="col-12 col-xl-6 border-right-blue-grey border-right-lighten-4 pr-2 p-0">
<div class="row my-2">
<div class="col-4">
...
<div class="col-md-9">
<input class="form-control" id="btc-stop-buy" name="btc-stop-buy" placeholder="$ 11916.9" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-stop-buy-limit">Limit</label>
<div class="col-md-9">
<input class="form-control" id="btc-stop-buy-limit" name="btc-stop-buy-limit" placeholder="$ 12000.0" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-stop-buy-amount">Amount</label>
<div class="col-md-9">
<input class="form-control" id="btc-stop-buy-amount" name="btc-stop-buy-amount" placeholder="0.026547 BTC" type="number"/>
</div>
</div>
<div class="form-group row">
<div class="col-md-3"></div>
...
<div class="col-md-9">
<input class="form-control" disabled="" id="btc-stop-buy-total" name="btc-stop-buy-total" placeholder="$ 318.1856" type="number"/>
</div>
</div>
<div class="form-actions pb-0">
<button class="btn round btn-success btn-block btn-glow" type="submit"> Buy BTC </button>
...
<div class="col-md-9">
<input class="form-control" id="btc-stop-sell" name="btc-stop-sell" placeholder="$ 11916.9" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-stop-sell-limit">Limit</label>
<div class="col-md-9">
<input class="form-control" id="btc-stop-sell-limit" name="btc-stop-sell-limit" placeholder="$ 12000.0" type="number"/>
</div>
</div>
<div class="form-group row">
<label class="col-md-3 col-form-label" for="btc-stop-sell-amount">Amount</label>
<div class="col-md-9">
<input class="form-control" id="btc-stop-sell-amount" name="btc-stop-sell-amount" placeholder="0.026547 BTC" type="number"/>
</div>
</div>
<div class="form-group row">
<div class="col-md-3"></div>
...
<div class="col-md-9">
<input class="form-control" disabled="" id="btc-stop-sell-total" name="btc-stop-sell-total" placeholder="$ 318.1856" type="number"/>
</div>
</div>
<div class="form-actions pb-0">
<button class="btn round btn-danger btn-block btn-glow" type="submit"> Sell BTC </button>
