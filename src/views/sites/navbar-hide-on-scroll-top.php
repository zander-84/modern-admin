...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\NavbarHideOnScrollTopAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Hide on Scroll Top</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="navbar-hide-on-scroll-top.html#">Navbars</a>
</li>
<li class="breadcrumb-item active">Hide on Scroll Top
                </li>
</ol>
</div>
</div>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="navbar-hide-on-scroll-top.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="navbar-hide-on-scroll-top.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="navbar-hide-on-scroll-top.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="navbar-hide-on-scroll-top.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<td>Tohide on scroll you need to set navbar fixed also, add fixed
                          navbar in bottom <code>.fixed-bottom</code> class in navbar
                          <code>&lt;nav&gt;</code> tag. Refer HTML markup line no
                          7.
                        </td>
</tr>
...
<td><code>verticalMenuConfig</code> block has a <code>menuType</code>                          variable, it contains navigation specific classes in that
                          you need to add <code>'menu-static'</code> for vertical
...
<td><code>horizontalMenuConfig</code> block has a <code>menuType</code>                          variable, it contains navigation specific classes in that
                          you need to add <code>'menu-static'</code> for horizontal
                          layout. Hide on scroll support only static navigation.</td>
</tr>
</tbody>
</table>
...
<ul>
<li>
<span class="text-bold-600">Line no 20-22:</span> Set navbar fixed class to <code>navbarConfig</code>                    variable value as <code>'fixed-top'</code> in <code>navbarConfig</code>                    block.</li>
<li>
<span class="text-bold-600">Line no 22:</span> Set navbar hide on scroll setting to <code>navbarHideOnScroll</code>                    variable value as <code>true</code> in <code>navbarConfig</code>                    block.</li>
<li>
<span class="text-bold-600">Line no 24-25:</span> Set navigation static class to <code>menuType</code>                    variable value as <code>'menu-static'</code> in <code>verticalMenuConfig</code>                    block.</li>
<li>
<span class="text-bold-600">Line no 27-28:</span> Set navigation static class to <code>menuType</code>                    variable value as <code>'navbar-static'</code> in <code>horizontalMenuConfig</code>                    block.</li>
<li>
<span class="text-bold-600">Line no 32-33:</span> <code>content</code> block has content
                    section html file included <code>include ../contents/navbar-hide-on-scroll-top.html</code>,
...
<p>If you want to use this layout on page level you need to define it
                  ...
                  <code>navbar-hide-on-scroll-top.pug</code>, however you can use
                  it on template level but it will generate whole template has a
                  navbar hide on scroll class.</p>
<pre class="language-pug" data-line="20-22, 24-25,  27-28, 34-35" data-line-offset="11">
