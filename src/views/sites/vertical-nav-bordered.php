...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\VerticalNavBorderedAsset::class,
    ]
]);
?>
...
<li class="breadcrumb-item"><a href="vertical-nav-bordered.html#">Navigation</a>
</li>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="vertical-nav-bordered.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="vertical-nav-bordered.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="vertical-nav-bordered.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="vertical-nav-bordered.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<span class="text-bold-600">Line no 12:</span> Contain the <code>.menu-bordered</code> class
                    to set vertical navigation border.</li>
</ul>
...
<td><code>verticalMenuConfig</code> block has a <code>menuDevider</code>                          variable, it contains navigation border specific settings
                          in that you need to add <code>true</code>.</td>
</tr>
</tbody>
</table>
</div>
...
<p>Use following PUG code to generate page or template having vertical
                  bordered navigation.</p>
<ul>
<li>
<span class="text-bold-600">Line no 20-21:</span> Set vertical bordered navigation class
                    to <code>menuDevider</code> variable value as <code>true</code>                    in <code>verticalMenuConfig</code> block.</li>
<li>
...
<p>If you want to use vertical bordered navigation options on page level
                  ...
                  have vertical bordered navigation.</p>
