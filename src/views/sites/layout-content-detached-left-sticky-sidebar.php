...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutContentDetachedLeftStickySidebarAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Detached Left Sticky Sidebar</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="layout-content-detached-left-sticky-sidebar.html#">Page Layouts</a>
</li>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-content-detached-left-sticky-sidebar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-content-detached-left-sticky-sidebar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-content-detached-left-sticky-sidebar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-content-detached-left-sticky-sidebar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<!-- Description -->
<section class="card" id="descriptioin">
...
<p>This section contains HTML Markup to create 3 column detached left
                    sticky sidebar layout. You need to add the <code>.content-detached-left-sidebar</code>                    class in the <code>&lt;body&gt;</code> tag as show in below markup
...
<span class="text-bold-600">Line no 33:</span> Contain the <code>.sidebar-detached</code>                      and <code>.sidebar-left</code> classes for adjusting detached
                      sidebar section in left side.</li>
<li>
<span class="text-bold-600">Line no 34:</span> Contain the <code>.sidebar-sticky</code>                      class, that will make the detached left sidebar sticky.</li>
</ul>
...
<p>This table contains required PUG variables to generate 3 column
                    detached left sticky sidebar layout.</p>
<div class="table-responsive">
<table class="table table-hover">
<thead>
<tr>
...
<p>To generate content detached left sticky sidebar layout page or
                    template, you need to use following PUG code.</p>
<ul>
<li>
<span class="text-bold-600">Line no 20-22:</span> You need to set <code>contentLayout</code>                      variable value as <code>'content-detached-left-sidebar'</code>                      in <code>pageConfig</code> block.</li>
<li>
<span class="text-bold-600">Line no 22: You need to set <code>sidebarSticky</code> variable
                        value as <code>true</code> in <code>pageConfig</code> block
                        to enable left sticky sidebar.</span>
</li>
<li>
<span class="text-bold-600">Line no 28-29:</span> <code>content</code> block has content
                      section html file included <code>include ../contents/layout-content-detached-left-sticky-sidebar.html</code>,
...
<p>If you want to use this layout on page level you need to define
                    ...
                    content detached left sticky sidebar <code>layout-content-detached-left-sticky-sidebar.pug</code>,
                    however you can use it on template level but it will generate
                    whole template as a content detached left sticky sidebar.</p>
<pre class="language-pug" data-line="20-22, 28-29, 31-32" data-line-offset="11">
            <code class="language-pug">
            block pageVars
            	- var pageTitle    = "Detached Left Sticky Sidebar"
            	- var pageSubTitle = "content layoutDetached left sticky sidebar"
            	- var description  = "The content detached left sticky sidebar layout with navigation, content area and detched left sticky sidebar."
            	- var activeMenu   = "layout-content-detached-left-sticky-sidebar"
            ...
            append breadcrumbs
            	+breadcrumbs([{url:"index.html",name:"Home"},{url:"#",name:"Page Layouts"}, {name:"Content detached left sticky sidebar"}])
            
            //- Include page content
            append content
            	include ../contents/layout-content-detached-left-sticky-sidebar.html
...
<a class="btn btn-primary" href="layout-content-detached-left-sticky-sidebar.html#">Button</a>
<!-- /Card sample -->
<hr/>
...
<div class="media">
<a class="media-left pr-1" href="layout-content-detached-left-sticky-sidebar.html#">
