...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\ComponentPillBadgesAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Pill Badges</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="component-pill-badges.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="component-pill-badges.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="component-pill-badges.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="component-pill-badges.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-pill</code>                      with <code>.badge-info</code>class within element to create
                      info pill badge.</p>
...
<p>Use the <code>.badge</code> class, followed by<code>.bg-blue-grey</code>class
                      within element to create blue grey label.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-pill</code>                      with <code>.badge-glow</code>class within element to create
                      glow styled pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by<code>.badge-border</code>                      with <code>.badge-primary</code>class within element to create
                      primary pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by<code>.badge-border</code>                      with <code>.badge-success</code>class within element to create
                      success pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-border</code>                      with <code>.badge-danger</code>class within element to create
                      danger pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-border</code>                      with <code>.badge-info</code>class within element to create
                      info pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-border</code>                      with <code>.badge-warning</code>class within element to create
                      warning pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-border</code>                      with <code>.bg-blue</code>class within element to create blue
                      pill badge.</p>
...
<div class="card-content">
<div class="card-body text-center">
<p>Use the <code>.badge</code> class, followed by <code>.badge-border</code>                      with <code>.badge-glow</code>class within element to create
                      glow styled pill badge.</p>
...
<h4>Square Pill
                <h4>
</h4></h4><p>For square pill badges, use <code>.badge-square</code> class with
