...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\FooterLightAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Footer Light</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="footer-light.html#">Footer</a>
</li>
<li class="breadcrumb-item active">Footer Light
                </li>
</ol>
</div>
</div>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="footer-light.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="footer-light.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="footer-light.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="footer-light.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>For light footer, Modern Admin provides light color footer options,
                  you can check light color footer on bottom of this page.</p>
</div>
<div class="alert bg-success alert-icon-left mb-2" role="alert">
<span class="alert-icon"><i class="la la-pencil-square"></i></span>
<strong>Experience it!</strong>
<p>This page contain footer light color options example, check on the
...
<div class="card-body">
<div class="card-text">
<p>This table contains all classes which can be used in light footer.
                  You can combine them as per footer light template requirements.</p>
...
<td>To set footer light color you need to add <code>.footer-light</code>                          class in footer <code>&lt;footer&gt;</code> tag. Refer
...
<div class="card-body">
<div class="card-text">
<p>This section contains HTML Markup to create light footer. This markup
                  define where to add css classes to make footer light.</p>
<ul>
<li>
...
<p>This table contains required PUG variables to generate light footer.</p>
<div class="table-responsive">
<table class="table table-hover">
<thead>
<tr>
...
<td><code>footerConfig</code> block has a <code>footerColor</code>                          variable, it contains footer color specific classes in
                          that you need to add <code>'footer-light'</code> class
                          for light footer.</td>
</tr>
</tbody>
</table>
...
<p>To generate footer light page or template, you need to use following
                  PUG code.</p>
<ul>
<li>
<span class="text-bold-600">Line no 20-21:</span> Set footer light class to <code>footerColor</code>                    variable value as <code>'footer-light'</code> in <code>footerConfig</code>                    block, it contains footer color specific classes in that you
                    need to add <code>'footer-light'</code>.</li>
<li>
<span class="text-bold-600">Line no 27-28:</span> <code>content</code> block has content
                    section html file included <code>include ../contents/footer-light.html</code>,
...
<p>If you want to use this layout on page level you need to define it
                  ...
                  footer <code>footer-light.pug</code>, however you can use it on
                  template level but it will generate whole template footer light.</p>
