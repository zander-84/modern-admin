...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\ColorPalettePurpleAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Purple Color Page</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="color-palette-purple.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="color-palette-purple.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="color-palette-purple.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="color-palette-purple.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-content">
<div class="card-body">
<p class="mt-1">Purple color palette contains 13 colors: 1 main purple color
...
<p class="mt-1">
<strong>Please note:</strong> You can use .bg-purple and .btn-purple
...
<tr>
<td><code>.bg-purple</code>
<br/><code>.bg-lighten-*</code></td>
<td>For <code>lighten</code> purple background color, this
                                two classes needed. Here *: 1,2,3,4 lighten purple
                                color options.</td>
</tr>
<tr>
<td><code>.bg-purple</code>
<br/><code>.bg-darken-*</code></td>
<td>For <code>darken</code> purple background color, this
                                two classes needed. Here *: 1,2,3,4 darken purple
                                color options.</td>
</tr>
<tr>
<td><code>.bg-purple</code>
<br/><code>.bg-accent-*</code></td>
<td>For <code>accent</code> purple background color, this
                                two classes needed. Here *: 1,2,3,4 accent purple
                                color options.</td>
</tr>
</tbody>
</table>
...
<tr>
<td><code>.border-purple</code>
<br/><code>.border-lighten-*</code></td>
<td>For lighten purple background color, this two classes
                                needed. Here *: 1,2,3,4 lighten purple color options.</td>
</tr>
<tr>
<td><code>.border-top-purple</code>
<br/><code>.border-top-lighten-*</code></td>
<td>For lighten purple <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-purple</code>
<br/><code>.border-bottom-lighten-*</code></td>
<td>For lighten purple <code>bottom</code> border. Use
                                this classes if you need to highlight only bottom
                                border.
                              </td>
</tr>
<tr>
<td><code>.border-right-purple</code>
<br/><code>.border-right-lighten-*</code></td>
<td>For lighten purple <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-purple</code>
<br/><code>.border-left-lighten-*</code></td>
<td>For lighten purple <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
<tr>
<td><code>.border-purple</code>
<br/><code>.border-darken-*</code></td>
<td>For darken purple background color, this two classes
                                needed. Here *: 1,2,3,4 darken purple color options.</td>
</tr>
<tr>
<td><code>.border-top-purple</code>
<br/><code>.border-top-darken-*</code></td>
<td>For darken purple <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-purple</code>
<br/><code>.border-bottom-darken-*</code></td>
<td>For darken purple <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-purple</code>
<br/><code>.border-right-darken-*</code></td>
<td>For darken purple <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-purple</code>
<br/><code>.border-left-darken-*</code></td>
<td>For darken purple <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
<tr>
<td><code>.border-purple</code>
<br/><code>.border-accent-*</code></td>
<td>For accent purple background color, this two classes
                                needed. Here *: 1,2,3,4 accent purple color options.</td>
</tr>
<tr>
<td><code>.border-top-purple</code>
<br/><code>.border-top-accent-*</code></td>
<td>For accent purple <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-purple</code>
<br/><code>.border-bottom-accent-*</code></td>
<td>For accent purple <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-purple</code>
<br/><code>.border-right-accent-*</code></td>
<td>For accent purple <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-purple</code>
<br/><code>.border-left-accent-*</code></td>
<td>For accent purple <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
</tbody>
</table>
...
<td>For <code>lighten</code> purple text color, this two
                                classes needed. Here *: 1,2,3,4 for lighten purple
                                color options.</td>
</tr>
<tr>
<td><code>.purple</code>
<br/><code>.darken-*</code></td>
<td>For <code>darken</code> purple text color, this two
                                classes needed. Here *: 1,2,3,4 for darken purple
                                color options.</td>
</tr>
<tr>
<td><code>.purple</code>
<br/><code>.accent-*</code></td>
<td>For <code>accent</code> purple text color, this two
                                classes needed. Here *: 1,2,3,4 for accent purple
                                color options.</td>
</tr>
</tbody>
</table>
