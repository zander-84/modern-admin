...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
        \zander84\modernadmin\assets\DashboardSalesAsset::class,
    ]
]);
?>
                        ...
                        <div class="card-content">
                            <div class="earning-chart position-relative">
                                ...
                                <div class="chart-stats position-absolute position-bottom-0 position-right-0 mb-2 mr-3">
                                    <a class="btn round btn-danger mr-1 btn-glow" href="dashboard-sales.html#">Statistics
                                        <i class="ft-bar-chart"></i></a>
                                    <span class="text-muted">for the <a class="danger darken-2"
                                                                        href="dashboard-sales.html#">last year.</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-xl mb-0" id="recent-orders">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li class="avatar avatar-sm pull-up"
                                                    data-original-title="Kimberly Simmons" data-popup="tooltip-custom"
                                                    data-toggle="tooltip">
                                                    <img alt="Avatar" class="media-object rounded-circle"
                                                         src="<?= $baseUrl; ?>/app-assets/images/portrait/small/avatar-s-4.png"/>
                                                </li>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-danger round" type="button">Mobile
                                            </button>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-sm btn-outline-success round" type="button">Tablet
                                            </button>
                                        </td>
                                        <td>
                                            <div class="progress progress-sm mt-1 mb-0 box-shadow-2">
                                        ...
                                        <td class="text-truncate p-1">
                                            <ul class="list-unstyled users-list m-0">
                                                <li class="avatar avatar-sm pull-up"
                                                    ...
                                                    data-toggle="tooltip">
                                                    <img alt="Avatar" class="media-object rounded-circle"
                                                         src="<?= $baseUrl; ?>/app-assets/images/portrait/small/avatar-s-1.png"/>
                                                </li>
                                                <li class="avatar avatar-sm pull-up" data-original-title="Willie Torres"
                                                    data-popup="tooltip-custom" data-toggle="tooltip">
                                                    <img alt="Avatar" class="media-object rounded-circle"
                                                         src="<?= $baseUrl; ?>/app-assets/images/portrait/small/avatar-s-2.png"/>
                                                </li>
                                                <li class="avatar avatar-sm pull-up" data-original-title="Rebecca Jones"
                                                    data-popup="tooltip-custom" data-toggle="tooltip">
                                                    <img alt="Avatar" class="media-object rounded-circle"
                                                         src="<?= $baseUrl; ?>/app-assets/images/portrait/small/avatar-s-3.png"/>
                                                </li>
                                                <li class="avatar avatar-sm">
                                            ...
                                            <div class="col-12">
                                                <div class="sales pr-2 pt-2">
                                                    ...
                                                    <div class="sales-yesterday">
                                                        ...
                                                        <div class="progress progress-sm mt-1 mb-0">
                                                            <div aria-valuemax="100" aria-valuemin="0"
                                                                 aria-valuenow="25" class="progress-bar bg-danger"
