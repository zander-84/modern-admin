...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\CardStatisticsAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Advance Statistics Cards</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="card-statistics.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="card-statistics.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="card-statistics.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="card-statistics.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="80" class="progress-bar bg-info" role="progressbar" style="width: 80%"></div>
</div>
</div>
</div>
</div>
...
<div class="progress mt-1 mb-0" style="height: 7px;">
<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="35" class="progress-bar bg-warning" role="progressbar" style="width: 35%"></div>
</div>
</div>
</div>
</div>
...
<div class="progress mt-1 mb-0" style="height: 7px;">
<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="60" class="progress-bar bg-success" role="progressbar" style="width: 60%"></div>
</div>
</div>
</div>
</div>
...
<div class="progress mt-1 mb-0" style="height: 7px;">
<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="40" class="progress-bar bg-danger" role="progressbar" style="width: 40%"></div>
</div>
</div>
</div>
</div>
...
<!-- Minimal Crypto Wallet Statistics with bg color section start -->
<section id="minimal-statistics-bg">
<div class="row">
<div class="col-12 mt-3 mb-1">
<h4 class="text-uppercase">Crypto Wallet Statistics With Background Color</h4>
<p>Statistics on minimal cards with background color.</p>
</div>
</div>
<!-- Crypto Stats 1 -->
<div class="row" id="crypto-stats-1">
<div class="col-xl-3 col-lg-6 col-12">
<div class="card bg-info">
<div class="card-content">
...
<div class="row">
<div class="col-7">
<h4 class="text-white mb-1"><i class="cc XRP" title="XRP"></i> Ripple</h4>
<h6 class="text-white">200 XRP</h6>
</div>
<div class="col-5 text-right">
<h4 class="text-white mb-1"><i class="la la-caret-up"></i> $150</h4>
<h6 class="text-white">$1.50</h6>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-7">
<h4 class="text-white mb-1"><i class="cc ETH" title="ETH"></i> Ethereum</h4>
<h6 class="text-white">10 ETH</h6>
</div>
<div class="col-5 text-right">
<h4 class="text-white mb-1"><i class="la la-caret-up"></i> $90</h4>
<h6 class="text-white">$944</h6>
</div>
</div>
</div>
</div>
...
<h6 class="text-white">24 LTC</h6>
</div>
<div class="col-5 text-right">
<h4 class="text-white mb-1"><i class="la la-caret-up"></i> $90</h4>
<h6 class="text-white">$180</h6>
</div>
</div>
</div>
</div>
...
<!-- Crypto Stats 2 -->
<div class="row" id="crypto-stats-2">
<div class="col-xl-3 col-lg-6 col-12">
<div class="card bg-info">
<div class="card-content">
<div class="card-body pb-1">
...
<h4 class="pt-1 m-0 text-white">200 XRP</h4>
</div>
<div class="col-6 text-right pl-0">
<h2 class="text-white mb-2 font-large-1">$1.50</h2>
...
<h4 class="pt-1 m-0 text-white">3.5 BTC</h4>
</div>
<div class="col-6 text-right pl-0">
<h3 class="text-white mb-2 font-large-1">$9,980</h3>
...
<h4 class="pt-1 m-0 text-white">10 ETH</h4>
</div>
<div class="col-6 text-right pl-0">
<h3 class="text-white mb-2 font-large-1">$944</h3>
...
<h4 class="pt-1 m-0 text-white">24 LTC</h4>
</div>
<div class="col-6 text-right pl-0">
<h3 class="text-white mb-2 font-large-1">$180</h3>
...
<h4 class="text-white mb-3"><i class="cc XRP" title="XRP"></i> Ripple</h4>
<h6 class="text-white mb-1">Balance</h6>
<h4 class="text-white">200 XRP</h4>
</div>
</div>
</div>
</div>
...
<h4 class="text-white mb-3"><i class="cc BTC" title="BTC"></i> Bitcoin</h4>
<h6 class="text-white mb-1">Balance</h6>
<h4 class="text-white">3.5 BTC</h4>
</div>
</div>
</div>
</div>
<div class="col-xl-3 col-lg-6 col-12">
<div class="card crypto-card-3 bg-danger">
<div class="card-content">
<div class="card-body cc ETH pb-1">
<h4 class="text-white mb-3"><i class="cc ETH" title="ETH"></i> Ethereum</h4>
<h6 class="text-white mb-1">Balance</h6>
<h4 class="text-white">10 ETH</h4>
</div>
</div>
</div>
</div>
...
<h4 class="text-white mb-3"><i class="cc LTC" title="LTC"></i> Litecoin</h4>
<h6 class="text-white mb-1">Balance</h6>
<h6 class="text-white">24 LTC</h6>
</div>
</div>
...
<!-- // Minimal Crypto Wallet Statistics with bg color section end -->
<!-- Minimal Crypto Wallet Statistics with bg color section start -->
<section id="minimal-statistics-bg">
<div class="row">
<div class="col-12 mt-3 mb-1">
<h4 class="text-uppercase">Compny Sales Statistics With Background Color</h4>
<p>Statistics on minimal cards with background color.</p>
</div>
</div>
<div class="row">
...
<h4 class="pt-1 m-0 text-white">45% <i class="la la-arrow-up"></i></h4>
</div>
<div class="col-6 text-right">
<h3 class="text-white mb-2">Sales</h3>
<span>90%</span>
<br/>
<span>Grate</span>
</div>
...
<div class="row text-white">
<div class="col-6">
<h1><i class="la la-star-o background-round text-white"></i></h1>
<h4 class="pt-1 m-0 text-white">10% <i class="la la-arrow-down"></i></h4>
</div>
<div class="col-6 text-right">
<h3 class="text-white mb-2">Product</h3>
<span>39%</span>
<br/>
<span>Average</span>
</div>
...
<h4 class="pt-1 m-0 text-white">20% <i class="la la-arrow-up"></i>
</h4></div>
<div class="col-6 text-right">
<h3 class="text-white mb-2">Profit</h3>
<span>60%</span>
<br/>
<span>Good</span>
</div>
...
<div class="row text-white">
<div class="col-6">
<h1><i class="la la-rocket background-round text-white"></i></h1>
<h4 class="pt-1 m-0 text-white">82% <i class="la la-arrow-up"></i>
</h4></div>
<div class="col-6 text-right">
<h3 class="text-white">Referral</h3>
<span>980</span>
<br/>
<span>Grate</span>
</div>
...
<div class="progress mt-1 mb-0" style="height: 7px;">
<div aria-valuemax="100" aria-valuemin="0" aria-valuenow="45" class="progress-bar bg-danger" role="progressbar" style="width: 45%"></div>
</div>
</div>
</div>
</div>
...
<p>Statistics on minimal cards with attractive icon section and background
                color.
              </p>
</div>
</div>
...
<p>Statistics on minimal cards with attractive icon section and gradient
                background color.</p>
</div>
</div>
<div class="row">
...
<p>Statistics on minimal cards with icon section, title, sub title and
                background color.</p>
</div>
</div>
<div class="row">
...
<div class="media-body p-2">
<h4 class="text-white">Total Comments</h4>
<span>Monthly blog comments</span>
</div>
<div class="media-right p-2 media-middle">
...
<div class="p-2 media-middle">
<h1 class="text-white">$76,456.00</h1>
</div>
<div class="media-body p-2">
...
<div class="card-content">
<input class="knob hide-value responsive angle-offset" data-angleoffset="40" data-fgcolor="#28D094" data-height="150" data-inputcolor="#e1e1e1" data-knob-icon="icon-note" data-linecap="round" data-readonly="true" data-thickness=".15" data-width="150" type="text" value="35"/>
...
<div class="card-content">
<input class="knob hide-value responsive angle-offset" data-angleoffset="0" data-fgcolor="#FF9149" data-height="150" data-inputcolor="#e1e1e1" data-knob-icon="icon-user" data-linecap="round" data-readonly="true" data-thickness=".15" data-width="150" type="text" value="56"/>
<ul class="list-inline clearfix mt-2">
<li>
...
<div class="card-content">
<input class="knob hide-value responsive angle-offset" data-angleoffset="20" data-fgcolor="#FF4961" data-height="150" data-inputcolor="#e1e1e1" data-knob-icon="icon-users" data-linecap="round" data-readonly="true" data-thickness=".15" data-width="150" type="text" value="75"/>
<ul class="list-inline clearfix mt-2">
<li class="border-right-blue-grey border-right-lighten-2 pr-2">
