...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\ColorPaletteCyanAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Cyan Color Page</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="color-palette-cyan.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="color-palette-cyan.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="color-palette-cyan.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="color-palette-cyan.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-content">
<div class="card-body">
<p>Cyan color palette contains 13 colors: 1 main cyan color and
...
<p class="mt-1">
<strong>Please note:</strong> You can use .bg-cyan and .btn-cyan as
...
<tr>
<td><code>.bg-cyan</code>
<br/><code>.bg-lighten-*</code></td>
<td>For <code>lighten</code> cyan background color, this
                                two classes needed. Here *: 1,2,3,4 lighten cyan
                                color options.</td>
</tr>
<tr>
<td><code>.bg-cyan</code>
<br/><code>.bg-darken-*</code></td>
<td>For <code>darken</code> cyan background color, this
                                two classes needed. Here *: 1,2,3,4 darken cyan color
                                options.
                              </td>
</tr>
<tr>
...
<td>For <code>accent</code> cyan background color, this
                                two classes needed. Here *: 1,2,3,4 accent cyan color
                                options.
                              </td>
</tr>
</tbody>
...
<p class="card-title">.border-cyan</p>
</div>
<div class="float-right">
<p class="card-title">
<small class="float-right">#00BCD4</small>
...
<tr>
<td><code>.border-cyan</code>
<br/><code>.border-lighten-*</code></td>
<td>For lighten cyan background color, this two classes
                                needed. Here *: 1,2,3,4 lighten cyan color options.</td>
</tr>
<tr>
<td><code>.border-top-cyan</code>
<br/><code>.border-top-lighten-*</code></td>
<td>For lighten cyan <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-cyan</code>
<br/><code>.border-bottom-lighten-*</code></td>
<td>For lighten cyan <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-cyan</code>
<br/><code>.border-right-lighten-*</code></td>
<td>For lighten cyan <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-cyan</code>
<br/><code>.border-left-lighten-*</code></td>
<td>For lighten cyan <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
<tr>
<td><code>.border-cyan</code>
<br/><code>.border-darken-*</code></td>
<td>For darken cyan background color, this two classes
                                needed. Here *: 1,2,3,4 darken cyan color options.</td>
</tr>
<tr>
<td><code>.border-top-cyan</code>
<br/><code>.border-top-darken-*</code></td>
<td>For darken cyan <code>top</code> border. Use this classes
                                if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-cyan</code>
<br/><code>.border-bottom-darken-*</code></td>
<td>For darken cyan <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-cyan</code>
<br/><code>.border-right-darken-*</code></td>
<td>For darken cyan <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-cyan</code>
<br/><code>.border-left-darken-*</code></td>
<td>For darken cyan <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
<tr>
<td><code>.border-cyan</code>
<br/><code>.border-accent-*</code></td>
<td>For accent cyan background color, this two classes
                                needed. Here *: 1,2,3,4 accent cyan color options.</td>
</tr>
<tr>
<td><code>.border-top-cyan</code>
<br/><code>.border-top-accent-*</code></td>
<td>For accent cyan <code>top</code> border. Use this classes
                                if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-cyan</code>
<br/><code>.border-bottom-accent-*</code></td>
<td>For accent cyan <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-cyan</code>
<br/><code>.border-right-accent-*</code></td>
<td>For accent cyan <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-cyan</code>
<br/><code>.border-left-accent-*</code></td>
<td>For accent cyan <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
</tbody>
</table>
...
<td>For <code>lighten</code> cyan text color, this two
                                classes needed. Here *: 1,2,3,4 for lighten cyan
                                color options.</td>
</tr>
<tr>
<td><code>.cyan</code>
<br/><code>.darken-*</code></td>
<td>For <code>darken</code> cyan text color, this two classes
                                needed. Here *: 1,2,3,4 for darken cyan color options.</td>
</tr>
<tr>
<td><code>.cyan</code>
<br/><code>.accent-*</code></td>
<td>For <code>accent</code> cyan text color, this two classes
                                needed. Here *: 1,2,3,4 for accent cyan color options.</td>
</tr>
</tbody>
</table>
</div>
