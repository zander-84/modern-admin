...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutContentRightSidebarAsset::class,
    ]
]);
?>
...
<a class="btn btn-primary" href="layout-content-right-sidebar.html#">Button</a>
<!-- /Card sample -->
<hr/>
...
<div class="media">
<a class="media-left pr-1" href="layout-content-right-sidebar.html#">
...
<h3 class="content-header-title mb-0 d-inline-block">Content right Sidebar</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="layout-content-right-sidebar.html#">Page Layouts</a>
</li>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-content-right-sidebar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-content-right-sidebar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-content-right-sidebar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-content-right-sidebar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Content layout right sidebar provides more navigations options
                      on page level. For the larger screen this layout provides best
                      usability. This layout use the third column as a sidebar section.</p>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>This table contains all classes related to the content right
                      sidebar layout. This is a custom layout classes for content
                      right sidebar layout page requirements.</p>
...
<td>In this layout content should be float in right side,
                              so <code>.content-left</code> class needs to add in
                              content wrapper. Refer HTML markup line no 27.</td>
</tr>
<tr>
<th scope="row"><code>.sidebar-right</code></th>
<td>In this layout sidebar should be float in right side,
                              so <code>.sidebar-right</code> class needs to add in
                              sidebar wrapper. Refer HTML markup line no 33.</td>
</tr>
</tbody>
</table>
</div>
...
<div class="card-body">
<div class="card-text">
<p>This section contains HTML Markup to create 3 column right sidebar
                      layout. You need to add the <code>.content-right-sidebar</code>                      class in the <code>&lt;body&gt;</code> tag as show in below
                      markup on line no 4. This layout has a navigation, content
                      and right sidebar sections with common header &amp; footer.</p>
<ul>
<li>
<span class="text-bold-600">Line no 27:</span> Contain the and <code>.content-left</code>                        class for adjusting content section in right side.</li>
<li>
<span class="text-bold-600">Line no 33:</span> Contain the <code>.sidebar-right</code>                        class for adjusting sidebar section in right side.</li>
</ul>
...
<div class="card-body">
<div class="card-text">
<p>Modern Admin use PUG as template engine to generate pages and
                      whole template quickly using node js, for getting start with
                      PUG usage &amp; template generating process please refer template
                      documentation.
                    </p>
<h5 class="card-title mt-2">PUG Variables</h5>
<p>This table contains required PUG variables to generate 3 column
                      right sidebar layout.</p>
<div class="table-responsive">
<table class="table table-hover">
<thead>
<tr>
...
<td><code>pageConfig</code> block has a page configuration
                              ...
                              variable <code>- var contentLayout = 'content-right-sidebar'</code></td>
</tr>
</tbody>
</table>
</div>
...
<span class="alert-icon"><i class="la la-info"></i></span>
                      Modern Admin Template <a class="white" href="../../../documentation/index.html" target="_blank"><u>documentation</u></a> has
                      full list of all blocks, datatype, variables and their description
                      table. Please review it for more configuration options.
                    </div>
<h5 class="card-title mt-2">PUG Code</h5>
<p>To generate content right sidebar layout page or template, you
                      need to use following PUG code.</p>
<ul>
<li>
<span class="text-bold-600">Line no 20-21:</span> You need to set <code>contentLayout</code>                        variable value as <code>'content-right-sidebar'</code> in
                        <code>pageConfig</code> block.</li>
<li>
<span class="text-bold-600">Line no 27-28:</span> <code>content</code> block has content
                        section html file included <code>include ../contents/layout-content-right-sidebar.html</code>,
...
<p>If you want to use this layout on page level you need to define
                      ...
                      for content right sidebar <code>layout-content-right-sidebar.pug</code>,
                      however you can use it on template level but it will generate
                      whole template as a content right sidebar.</p>
