...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\Error404WithNavbarAsset::class,
    ]
]);
?>
...
<a class="btn btn-social-icon mr-1 mb-1 btn-outline-facebook" href="error-404-with-navbar.html#">
<span class="la la-facebook"></span>
</a>
<a class="btn btn-social-icon mr-1 mb-1 btn-outline-twitter" href="error-404-with-navbar.html#">
<span class="la la-twitter"></span>
</a>
<a class="btn btn-social-icon mr-1 mb-1 btn-outline-linkedin" href="error-404-with-navbar.html#">
<span class="la la-linkedin font-medium-4"></span>
</a>
<a class="btn btn-social-icon mr-1 mb-1 btn-outline-github" href="error-404-with-navbar.html#">
