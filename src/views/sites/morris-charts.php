...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="morris-charts.html#"><i class="la la-calendar-check-o"></i> Calender</a>
...
<div class="dropdown-divider"></div><a class="dropdown-item" href="morris-charts.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
