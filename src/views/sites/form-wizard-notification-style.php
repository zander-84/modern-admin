...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\FormWizardNotificationStyleAsset::class,
    ]
]);
?>
...
<li class="breadcrumb-item"><a href="form-wizard-notification-style.html#">Page</a>
</li>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="form-wizard-notification-style.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="form-wizard-notification-style.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="form-wizard-notification-style.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="form-wizard-notification-style.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<select class="c-select form-control" data-placeholder="Type to search cities" id="eventType1" name="eventType1">
...
<input class="form-control" id="jobTitle2" type="text"/>
</div>
<div class="form-group">
...
<select class="c-select form-control" data-placeholder="Type to search cities" id="eventType2" name="eventType2">
<option value="Banquet">Banquet</option>
<option value="Fund Raiser">Fund Raiser</option>
<option value="Dinner Party">Dinner Party</option>
<option value="Wedding">Wedding</option>
...
<input class="form-control required" id="jobTitle3" name="jobTitle" type="text"/>
</div>
<div class="form-group">
...
<input class="form-control" id="jobTitle4" type="text"/>
</div>
<div class="form-group">
...
<select class="c-select form-control" data-placeholder="Type to search cities" id="eventType4" name="eventType4">
<option value="Banquet">Banquet</option>
<option value="Fund Raiser">Fund Raiser</option>
<option value="Dinner Party">Dinner Party</option>
<option value="Wedding">Wedding</option>
