...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\ContentTextUtilitiesAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Text Utilities</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="content-text-utilities.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="content-text-utilities.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="content-text-utilities.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="content-text-utilities.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<!-- Contextual colors -->
<section class="card" id="contextual-colors">
...
<div class="card-body">
<div class="card-text">
<p>Convey meaning through color with a handful of emphasis utility classes.
                  These may also be applied to links and will darken on hover just
                  like our default link styles.</p>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Modern Admin also provide custom <a href="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/color-red.html" target="_blank">color palette</a>                  for the text, below table show you usage.</p>
<p>You can also use text lighten, darken and accent classes.</p>
<ul>
<li><code>li.red .lighten-*</code> For lighten red text color, this
                    two classes needed. Here *: 1,2,3,4 for lighten red color options.</li>
<li><code>.red .darken-*</code> For darken red text color, this two
                    classes needed. Here *: 1,2,3,4 for darken red color options.</li>
<li><code>.red .accent-*</code> For accent red text color, this two
                    classes needed. Here *: 1,2,3,4 for accent red color options.</li>
</ul>
</div>
</div>
<div class="table-responsive">
...
<section class="card" id="contextual-background">
<div class="card-header">
...
<div class="card-body">
<div class="card-text">
<p>Contextual text color classes, easily set the background of an element
                  to any contextual class. Anchor components will darken on hover,
                  just like the text classes.</p>
</div>
</div>
<div class="table-responsive">
<table class="table">
...
<div class="card-body">
<div class="card-text">
<p>Modern Admin also provide custom <a href="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/color-red.html" target="_blank">color palette</a>                  for the background colors, below table show you usage.</p>
<p>You can also use background lighten, darken and accent classes.</p>
<ul>
<li><code>.bg-red .bg-lighten-*</code> For lighten red text color,
                    this two classes needed. Here *: 1,2,3,4 for lighten red color
                    options.
                  </li>
<li><code>.bg-red .bg-darken-*</code> For darken red text color, this
                    two classes needed. Here *: 1,2,3,4 for darken red color options.</li>
<li><code>.bg-red .bg-accent-*</code> For accent red text color, this
                    two classes needed. Here *: 1,2,3,4 for accent red color options.</li>
</ul>
</div>
</div>
<div class="table-responsive">
...
<!--/ Contextual background -->
<!-- Text alignment -->
<section class="card" id="text-alignment">
<div class="card-header">
...
<div class="card-body">
<div class="card-text">
<p>For left, right, and center alignment, responsive classes are available
                  that use the same viewport width breakpoints as the grid system.</p>
</div>
</div>
<div class="table-responsive">
...
<!--/ Text alignment -->
<!-- Text transform -->
<section class="card" id="text-transform">
<div class="card-header">
...
<p>Note how <code class="highlighter-rouge">text-capitalize</code> only
                  changes the first letter of each word, leaving the case of any
                  other letters unaffected.</p>
</div>
</div>
<div class="table-responsive">
<table class="table mb-0">
...
<!--/ Text transform -->
<!-- Text option -->
<section class="card" id="text-option">
<div class="card-header">
...
<p>Modern Admin provide font large &amp; small sizes variant classes to
                  change font size.</p>
</div>
</div>
<div class="table-responsive">
...
<p>Modern Admin provide font weight class <code>.text-bold-{weight}</code>,
                  where <code>{weight} value can be 100,200 ... 900.</code></p>
</div>
</div>
<div class="table-responsive">
<table class="table mb-0">
...
<p><code class="highlighter-rouge">.mark</code> and <code class="highlighter-rouge">.small</code>                  classes are also available to apply the same styles as <code class="highlighter-rouge">&lt;mark&gt;</code>                  and <code class="highlighter-rouge">&lt;small&gt;</code> while
                  avoiding any unwanted semantic implications that the tags would
                  bring.
                </p>
<p class="">While not shown above, feel free to use <code class="highlighter-rouge">&lt;b&gt;</code>                  and <code class="highlighter-rouge">&lt;i&gt;</code> in HTML5.
                  <code class="highlighter-rouge">&lt;b&gt;</code> is meant to highlight
                  words or phrases without conveying additional importance while
                  <code class="highlighter-rouge">&lt;i&gt;</code> is mostly for
...
<td>
<p>Sample
                        <abbr data-original-title="Abbr title" data-popup="tooltip" title="">abbreviation</abbr>
</p>
</td>
<td>
<pre class="language-markup">
...
<td>
<p>Sample
                        <abbr class="initialism" title="HyperText Markup Language">HTML</abbr> title.</p>
</td>
<td>
<pre class="language-markup">
                              <code>
