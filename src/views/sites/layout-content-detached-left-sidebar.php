...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutContentDetachedLeftSidebarAsset::class,
    ]
]);
?>
...
<li class="breadcrumb-item"><a href="layout-content-detached-left-sidebar.html#">Page Layouts</a>
</li>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-content-detached-left-sidebar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-content-detached-left-sidebar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-content-detached-left-sidebar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-content-detached-left-sidebar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Content layout with detached left sidebar provides more navigations
                    options on page level. For the larger screen this layout provides
                    best usability. This layout use the third column as a sidebar
                    section.
                  </p>
</div>
</div>
...
<p>This table contains all classes related to the content detached
                    left sidebar layout. This is a custom layout classes for content
                    detached left sidebar layout page requirements.</p>
...
<td>In this layout content section is detached from left sidebar,
                            for that <code>.content-detached</code> class needs to
                            add in content wrapper. Refer HTML markup line no 27.</td>
</tr>
<tr>
...
<td>In this layout left sidebar section is detached from content,
                            for that <code>.sidebar-detached</code> class needs to
                            add in sidebar wrapper. Refer HTML markup line no 33.</td>
</tr>
<tr>
...
<div class="card-body">
<div class="card-text">
<p>This section contains HTML Markup to create 3 column detached left
                    sidebar layout. You need to add the <code>.content-detached-left-sidebar</code>                    class in the <code>&lt;body&gt;</code> tag as show in below markup
                    on line no 4. This layout has a navigation, content and left
                    detached sidebar sections with common header &amp; footer.</p>
<p>
<span class="text-bold-600">Line no 27:</span> Contain the <code>.content-detached</code>                    and <code>.content-right</code> classes for adjusting detached
                    content section in right side.</p>
<p>
<span class="text-bold-600">Line no 33:</span> Contain the <code>.sidebar-detached</code>                    and <code>.sidebar-left</code> classes for adjusting detached
                    sidebar section in left side.</p>
<p>Modern has a ready to use starter kit for this layout, you can
                    use this layout directly by using the <a href="https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/html/ltr/vertical-modern-menu-template/sk-content-detached-left-sidebar.html"><code>layout-content-detached-left-sidebar.html</code></a></p>
<pre class="language-markup" data-line="4, 27, 33">
        <code class="language-markup">
            &lt;!DOCTYPE html&gt;
              &lt;html lang="en"&gt;
                &lt;head&gt;&lt;/head&gt;
                &lt;body data-menu="vertical-menu" class="vertical-layout vertical-menu content-detached-left-sidebar menu-expanded"&gt;
...
<p>This table contains required PUG variables to generate 3 column
                    detached left sidebar layout.</p>
<div class="table-responsive">
<table class="table table-hover">
<thead>
<tr>
...
<td><code>'content-detached-left-sidebar'</code></td>
<td><code>pageConfig</code> block has a page configuration
                            variables, for detached left sidebar layout need to define
                            variable <code>- var contentLayout = 'content-detached-left-sidebar'</code>.</td>
</tr>
</tbody>
</table>
</div>
...
<p>To generate content detached left sidebar layout page or template,
                    you need to use following PUG code.</p>
<p>
<span class="text-bold-600">Line no 20-21: You need to set <code>contentLayout</code> variable
                      value as <code>'content-detached-left-sidebar'</code> in <code>pageConfig</code>                      block.</span>
</p>
<p>
<span class="text-bold-600">Line no 27-28:</span> <code>content</code> block has content
                    section html file included <code>include ../contents/layout-content-detached-left-sidebar.html</code>,
                    which can be customizable on page level.</p>
<p>
<span class="text-bold-600">Line no 30-31:</span> <code>sidebar</code> block has sidebar
...
<p>If you want to use this layout on page level you need to define
                    ...
                    content detached left sidebar <code>layout-content-detached-left-sidebar.pug</code>,
                    however you can use it on template level but it will generate
                    whole template as a content detached left sidebar.</p>
<pre class="language-pug" data-line="20-21, 27-28, 30-31" data-line-offset="11">
            <code class="language-pug">
                block pageVars
                	- var pageTitle    = "Detached Left Sidebar"
                	- var pageSubTitle = "Content detached left sidebar"
                	- var description  = "The content detached left sidebar layout with navigation, content area and detched left sidebar."
                	- var activeMenu   = "layout-content-detached-left-sidebar"
                
                extends template
                
                append pageConfig
                	- var contentLayout = 'content-detached-left-sidebar'
                
                append breadcrumbs
                	+breadcrumbs([{url:"index.html",name:"Home"},{url:"#",name:"Page Layouts"}, {name:"Content detached left sidebar"}])
                
                //- Include page content
                append content
                	include ../contents/layout-content-detached-left-sidebar.html
...
<a class="btn btn-primary" href="layout-content-detached-left-sidebar.html#">Button</a>
<!-- /Card sample -->
<hr/>
...
<div class="media">
<a class="media-left pr-1" href="layout-content-detached-left-sidebar.html#">
