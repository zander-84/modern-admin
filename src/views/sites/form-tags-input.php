...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\FormTagsInputAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Tag Inputs</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="form-tags-input.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="form-tags-input.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="form-tags-input.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="form-tags-input.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<p class="text-muted">By default close char is <code>"×"</code>. Pass empty
