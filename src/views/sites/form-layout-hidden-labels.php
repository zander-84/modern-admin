...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\FormLayoutHiddenLabelsAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Hidden Label Forms</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="form-layout-hidden-labels.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="form-layout-hidden-labels.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="form-layout-hidden-labels.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="form-layout-hidden-labels.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="input-group">
<div class="d-inline-block custom-control custom-radio mr-1">
<input checked="" class="custom-control-input" id="yes1" name="customer2" type="radio"/>
