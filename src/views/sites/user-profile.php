...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\UserProfileAsset::class,
    ]
]);
?>
...
<div class="card-img-top img-fluid bg-cover height-300" style="background: url('https://pixinvent.com/modern-admin-clean-bootstrap-4-dashboard-html-template/app-assets/images/carousel/22.jpg') 50%;"></div>
<div class="media profil-cover-details w-100">
<div class="media-left pl-2 pt-2">
<a class="profile-image" href="user-profile.html#">
<img alt="Card image" class="rounded-circle img-border height-100" src="<?=$baseUrl;?>/app-assets/images/portrait/small/avatar-s-8.png"/>
</a>
</div>
...
<button class="btn btn-primary d-" type="button"><i class="la la-plus"></i> Follow</button>
<div aria-label="Basic example" class="btn-group d-none d-md-block float-right ml-2" role="group">
<button class="btn btn-success" type="button"><i class="la la-dashcube"></i> Message</button>
<button class="btn btn-success" type="button"><i class="la la-cog"></i></button>
</div>
</div>
</div>
</div>
...
<button aria-expanded="false" aria-label="Toggle navigation" class="navbar-toggler d-sm-none" data-toggle="collapse" type="button"></button>
<nav class="navbar navbar-expand-lg">
<div class="collapse navbar-collapse" id="navbarSupportedContent">
<ul class="navbar-nav mr-auto">
<li class="nav-item active">
<a class="nav-link" href="user-profile.html#"><i class="la la-line-chart"></i> Timeline <span class="sr-only">(current)</span></a>
</li>
<li class="nav-item">
<a class="nav-link" href="user-profile.html#"><i class="la la-user"></i> Profile</a>
</li>
<li class="nav-item">
<a class="nav-link" href="user-profile.html#"><i class="la la-briefcase"></i> Projects</a>
</li>
<li class="nav-item">
<a class="nav-link" href="user-profile.html#"><i class="la la-heart-o"></i> Favourites</a>
</li>
<li class="nav-item">
<a class="nav-link" href="user-profile.html#"><i class="la la-bell-o"></i> Notifications</a>
</li>
</ul>
</div>
</nav></nav></div>
...
<a class="btn btn-primary" href="user-profile.html#"><i class="la la-calendar-o"></i> Today</a>
</li>
</ul>
<ul class="timeline">
<li class="timeline-line"></li>
...
<div class="timeline-badge">
<a class="border-silc" data-container="body" data-context="inverse" data-original-title="block highlight" href="user-profile.html#" title=""></a>
</div>
<div class="timeline-card card border-grey border-lighten-2">
<div class="card-header">
...
<li class="timeline-line"></li>
<li class="timeline-group">
<a class="btn btn-primary" href="user-profile.html#"><i class="la la-calendar-o"></i> 2016</a>
</li>
</ul>
<ul class="timeline">
<li class="timeline-line"></li>
...
<li class="timeline-item">
<div class="timeline-badge">
<span class="bg-purple bg-lighten-1" data-placement="right" data-toggle="tooltip" title="Nullam facilisis fermentum"><i class="la la-area-chart"></i></span>
</div>
<div class="timeline-card card border-grey border-lighten-2">
<div class="card-header">
...
<p class="card-text">Nullam facilisis fermentum aliquam. Suspendisse ornare dolor
                        ...
                        elit tellus, porta ut orci sed, fermentum bibendum nisi.</p>
<div class="chart-container">
<div class="height-400 overflow-hidden echart-container" id="non-ribbon-chord"></div>
</div>
</div>
</div>
<div class="card-footer px-0 py-0">
...
<li class="timeline-line"></li>
<li class="timeline-group">
<a class="btn btn-primary" href="user-profile.html#"><i class="la la-calendar-o"></i> 2015</a>
</li>
</ul>
<ul class="timeline">
<li class="timeline-line"></li>
...
<li class="timeline-line"></li>
<li class="timeline-group">
<a class="btn btn-primary" href="user-profile.html#"><i class="la la-calendar-o"></i> 2014</a>
</li>
</ul>
<ul class="timeline">
<li class="timeline-line"></li>
...
<li class="timeline-line"></li>
<li class="timeline-group">
<a class="btn btn-primary" href="user-profile.html#"><i class="la la-calendar-o"></i> Founded in 2012</a>
</li>
</ul>
</section>
</div>
