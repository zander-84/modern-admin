...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\HeadersBreadcrumbsTopWithDescriptionAsset::class,
    ]
]);
?>
...
<li class="breadcrumb-item"><a href="headers-breadcrumbs-top-with-description.html#">Page headers</a>
</li>
...
<h3 class="content-header-title">Breadcrumbs top with description</h3>
...
<div aria-labelledby="btnGroupDrop1" class="dropdown-menu"><a class="dropdown-item" href="card-bootstrap.html">Cards</a><a class="dropdown-item" href="component-buttons-extended.html">Buttons</a><i class="la la-bar-chart"></i></div>
</div>
</div>
<div class="content-header-lead col-12 mt-1">
<p class="lead">Page header with page title, description, breadcrumbs at top &amp; content
            title.
          </p>
</div>
</div>
...
<p>This page contain breadcrumbs top with description example, check
                  on the top of the page container section.</p>
</div>
</div>
</div>
</section>
...
<div class="card-content">
<div class="card-body">
<p class="card-text">This section contains HTML Markup to create page with breadcrumbs top
                with description.</p>
<p class="card-text">You can use below HTML breadcrumbs top with description page header
...
<td>You need to append <code>page-header</code> block parameter
                        as <code>'include page-headers/breadcrumbs-top-with-description'</code>.</td>
</tr>
</tbody>
</table>
</div>
<h5 class="card-title mt-2">PUG Code</h5>
<p class="card-text">To generate page with breadcrumbs top with description header or template,
...
<span class="text-bold-600">Line no 22-23:</span> <code>page-header</code> block has a page/template
                specific configuration parameter, in that for breadcrumbs top with
                description header you need to define parameter <code>include page-headers/breadcrumbs-top-with-description</code>.
...
<p class="card-text">If you want to use this layout on page level you need to define it
                ...
                top with description <code>breadcrumbs-top-with-description.pug</code>.</p>
