...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\LayoutContentDetachedRightSidebarAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Detached Right Sidebar</h3>
<div class="row breadcrumbs-top d-inline-block">
<div class="breadcrumb-wrapper col-12">
<ol class="breadcrumb">
<li class="breadcrumb-item"><a href="index.html">Home</a>
</li>
<li class="breadcrumb-item"><a href="layout-content-detached-right-sidebar.html#">Page Layouts</a>
</li>
<li class="breadcrumb-item active">Content detached right sidebar
                </li>
</ol>
</div>
</div>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="layout-content-detached-right-sidebar.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="layout-content-detached-right-sidebar.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="layout-content-detached-right-sidebar.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="layout-content-detached-right-sidebar.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Content layout with detached right sidebar provides more navigations
...
<p>This table contains all classes related to the content detached
                    right sidebar layout. This is a custom layout classes for content
                    detached right sidebar layout page requirements.</p>
...
<td>In this layout content section is detached from right sidebar,
...
<td>In this layout right sidebar section is detached from content,
...
<p>This section contains HTML Markup to create 3 column detached right
                    sidebar layout. You need to add the <code>.content-detached-right-sidebar</code>                    class in the <code>&lt;body&gt;</code> tag as show in below markup
...
<span class="text-bold-600">Line no 33:</span> Contain the <code>.sidebar-detached</code>                    and <code>.sidebar-right</code> classes for adjusting detached
                    sidebar section in right side.</p>
...
<p>This table contains required PUG variables to generate 3 column
                    detached right sidebar layout.</p>
<div class="table-responsive">
<table class="table table-hover">
<thead>
<tr>
...
<p>To generate content detached right sidebar layout page or template,
                    you need to use following PUG code.</p>
<p>
<span class="text-bold-600">Line no 20-21:</span> You need to set <code>contentLayout</code>                    variable value as <code>'content-detached-right-sidebar'</code>                    in <code>pageConfig</code> block.</p>
<p>
<span class="text-bold-600">Line no 27-28:</span> <code>content</code> block has content
                    section html file included <code>include ../contents/layout-content-detached-right-sidebar.html</code>,
...
<p>If you want to use this layout on page level you need to define
                    ...
                    content detached right sidebar <code>layout-content-detached-right-sidebar.pug</code>,
                    however you can use it on template level but it will generate
                    whole template as a content detached right sidebar.</p>
<pre class="language-pug" data-line="20-21, 27-28, 30-31" data-line-offset="11">
              <code class="language-pug">
                block pageVars
                	- var pageTitle    = "Detached Right Sidebar"
                	- var pageSubTitle = "Content detached right sidebar"
                	- var description  = "The content detached right sidebar layout with navigation, content area and detched right sidebar."
                	- var activeMenu   = "layout-content-detached-right-sidebar"
                ...
                append breadcrumbs
                	+breadcrumbs([{url:"index.html",name:"Home"},{url:"#",name:"Page Layouts"}, {name:"Content detached right sidebar"}])
                
                //- Include page content
                append content
                	include ../contents/layout-content-detached-right-sidebar.html
...
<a class="btn btn-primary" href="layout-content-detached-right-sidebar.html#">Button</a>
<!-- /Card sample -->
<hr/>
...
<div class="media">
<a class="media-left pr-1" href="layout-content-detached-right-sidebar.html#">
