...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\ColorPaletteYellowAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Yellow Color</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="color-palette-yellow.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="color-palette-yellow.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="color-palette-yellow.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="color-palette-yellow.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-content">
<div class="card-body">
<p>Yellow color palette contains 13 colors: 1 main yellow color
...
<p class="mt-1">
<strong>Please note:</strong> You can use .bg-yellow and .btn-yellow
...
<tr>
<td><code>.bg-yellow</code>
<br/><code>.bg-lighten-*</code></td>
<td>For <code>lighten</code> yellow background color, this
                                two classes needed. Here *: 1,2,3,4 lighten yellow
                                color options.</td>
</tr>
<tr>
<td><code>.bg-yellow</code>
<br/><code>.bg-darken-*</code></td>
<td>For <code>darken</code> yellow background color, this
                                two classes needed. Here *: 1,2,3,4 darken yellow
                                color options.</td>
</tr>
<tr>
<td><code>.bg-yellow</code>
<br/><code>.bg-accent-*</code></td>
<td>For <code>accent</code> yellow background color, this
                                two classes needed. Here *: 1,2,3,4 accent yellow
                                color options.</td>
</tr>
</tbody>
</table>
...
<tr>
<td><code>.border-yellow</code>
<br/><code>.border-lighten-*</code></td>
<td>For lighten yellow background color, this two classes
                                needed. Here *: 1,2,3,4 lighten yellow color options.</td>
</tr>
<tr>
<td><code>.border-top-yellow</code>
<br/><code>.border-top-lighten-*</code></td>
<td>For lighten yellow <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-yellow</code>
<br/><code>.border-bottom-lighten-*</code></td>
<td>For lighten yellow <code>bottom</code> border. Use
                                this classes if you need to highlight only bottom
                                border.
                              </td>
</tr>
<tr>
<td><code>.border-right-yellow</code>
<br/><code>.border-right-lighten-*</code></td>
<td>For lighten yellow <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-yellow</code>
<br/><code>.border-left-lighten-*</code></td>
<td>For lighten yellow <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
<tr>
<td><code>.border-yellow</code>
<br/><code>.border-darken-*</code></td>
<td>For darken yellow background color, this two classes
                                needed. Here *: 1,2,3,4 darken yellow color options.</td>
</tr>
<tr>
<td><code>.border-top-yellow</code>
<br/><code>.border-top-darken-*</code></td>
<td>For darken yellow <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-yellow</code>
<br/><code>.border-bottom-darken-*</code></td>
<td>For darken yellow <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-yellow</code>
<br/><code>.border-right-darken-*</code></td>
<td>For darken yellow <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-yellow</code>
<br/><code>.border-left-darken-*</code></td>
<td>For darken yellow <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
<tr>
<td><code>.border-yellow</code>
<br/><code>.border-accent-*</code></td>
<td>For accent yellow background color, this two classes
                                needed. Here *: 1,2,3,4 accent yellow color options.</td>
</tr>
<tr>
<td><code>.border-top-yellow</code>
<br/><code>.border-top-accent-*</code></td>
<td>For accent yellow <code>top</code> border. Use this
                                classes if you need to highlight only top border.</td>
</tr>
<tr>
<td><code>.border-bottom-yellow</code>
<br/><code>.border-bottom-accent-*</code></td>
<td>For accent yellow <code>bottom</code> border. Use this
                                classes if you need to highlight only bottom border.</td>
</tr>
<tr>
<td><code>.border-right-yellow</code>
<br/><code>.border-right-accent-*</code></td>
<td>For accent yellow <code>right</code> border. Use this
                                classes if you need to highlight only right border.</td>
</tr>
<tr>
<td><code>.border-left-yellow</code>
<br/><code>.border-left-accent-*</code></td>
<td>For accent yellow <code>left</code> border. Use this
                                classes if you need to highlight only left border.</td>
</tr>
</tbody>
</table>
...
<td>For <code>lighten</code> yellow text color, this two
                                classes needed. Here *: 1,2,3,4 for lighten yellow
                                color options.</td>
</tr>
<tr>
<td><code>.yellow</code>
<br/><code>.darken-*</code></td>
<td>For <code>darken</code> yellow text color, this two
                                classes needed. Here *: 1,2,3,4 for darken yellow
                                color options.</td>
</tr>
<tr>
<td><code>.yellow</code>
<br/><code>.accent-*</code></td>
<td>For <code>accent</code> yellow text color, this two
                                classes needed. Here *: 1,2,3,4 for accent yellow
                                color options.</td>
</tr>
</tbody>
</table>
