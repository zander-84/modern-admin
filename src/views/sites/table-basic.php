...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\TableBasicAsset::class,
    ]
]);
?>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="table-basic.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="table-basic.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="table-basic.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="table-basic.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
