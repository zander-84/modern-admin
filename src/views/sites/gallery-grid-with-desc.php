...
$baseUrl = \zander84\modernadmin\widgets\ModernRegisterAsset::widget([
    'assets' => [
            \zander84\modernadmin\assets\GalleryGridWithDescAsset::class,
    ]
]);
?>
...
<h3 class="content-header-title mb-0 d-inline-block">Gallery Media Grid With Description</h3>
...
<div aria-labelledby="dropdownBreadcrumbButton" class="dropdown-menu"><a class="dropdown-item" href="gallery-grid-with-desc.html#"><i class="la la-calendar-check-o"></i> Calender</a>
<a class="dropdown-item" href="gallery-grid-with-desc.html#"><i class="la la-cart-plus"></i> Cart</a>
<a class="dropdown-item" href="gallery-grid-with-desc.html#"><i class="la la-life-ring"></i> Support</a>
<div class="dropdown-divider"></div><a class="dropdown-item" href="gallery-grid-with-desc.html#"><i class="la la-cog"></i> Settings</a>
</div>
</div>
</div>
</div>
...
<div class="card-body">
<div class="card-text">
<p>Video &amp; Image gallery grid with title, description &amp; photo-swipe
                  integration. Display gallery in 4-2-1 columns.</p>
...
<div class="card-body">
<div class="card-text">
<p>Image gallery grid with title, description &amp; photo-swipe integration.
                  Display images gallery in 4-2-1 columns and photo-swipe provides
                  gallery features.</p>
</div>
</div>
...
<p>This section contain responsive embedded video gallery with grid
                  3-2-1 columns with title &amp; description. This demo contain vimeo
...
<iframe class="gallery-thumbnail" height="360" src="https://player.vimeo.com/video/118589137?title=0&amp;byline=0" width="640"></iframe>
</div>
<div class="card-body px-0">
...
<div class="card border-grey border-lighten-2">
<div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
<iframe class="gallery-thumbnail" height="360" src="https://player.vimeo.com/video/173541384?color=ff9933&amp;title=0&amp;byline=0" width="640"></iframe>
</div>
<div class="card-body px-0">
<h4 class="card-title">Card title</h4>
...
<div class="card border-grey border-lighten-2">
<div class="card-img-top embed-responsive embed-responsive-item embed-responsive-16by9">
<iframe class="gallery-thumbnail" height="360" src="https://player.vimeo.com/video/161753790?color=ff9933&amp;title=0&amp;byline=0" width="640"></iframe>
</div>
<div class="card-body px-0">
<h4 class="card-title">Card title</h4>
