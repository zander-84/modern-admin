...
//                     if (this.obj) {
//                         var e;
//                         if (!0 === a(".main-menu").data("scroll-to-active")) e = a(".main-menu-content").find("li.active").parents("li").length > 0 ? a(".main-menu-content").find("li.active").parents("li").last().position() : a(".main-menu-content").find("li.active").position(),
//                             setTimeout(function () {
...
//                     "vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu") && "vertical-overlay-menu" != t.data("menu") || !a(".main-menu").hasClass("menu-fixed") || (a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight() - a(".main-menu-footer").outerHeight()), this.update())
//                 }
//             },
//             init: function (e) {
...
//                     var n = "";
//                     if (!0 === e && (n = "collapsed"), "vertical-menu-modern" == t.data("menu")) {
//                         var i = "";
//                         "undefined" != typeof Storage && (i = localStorage.getItem("menuLocked")),
//                             "false" === i ? this.change("collapsed") : this.change()
//                     } else this.change(n)
...
//                 this.reset();
//                 var i, s, o = t.data("menu");
//                 if (n) switch (n.name) {
//                     case "xl":
//                     case "lg":
//                         "vertical-overlay-menu" === o ? this.hide() : "vertical-compact-menu" === o ? this.open() : "horizontal-menu" === o && "lg" == n.name ? this.collapse() : "collapsed" === e ? this.collapse(e) : this.expand();
//                         break;
//                     case "md":
//                         "vertical-overlay-menu" === o ? this.hide() : "vertical-compact-menu" === o ? this.open() : this.collapse();
//                         break;
//                     case "sm":
//                     case "xs":
//                         this.hide()
//                 }
//                 "vertical-menu" !== o && "vertical-compact-menu" !== o && "vertical-content-menu" !== o && "vertical-menu-modern" !== o || this.toOverlayMenu(n.name),
//                 t.is(".horizontal-layout") && !t.hasClass(".horizontal-menu-demo") && (this.changeMenu(n.name), a(".menu-toggle").removeClass("is-active")),
...
//
//                     }),
//                 "horizontal-menu" == o && ("sm" == n.name || "xs" == n.name ? a(".menu-fixed").length && a(".menu-fixed").unstick() : a(".navbar-fixed").length && a(".navbar-fixed").sticky()),
//                 "vertical-menu" !== o && "vertical-overlay-menu" !== o && "vertical-content-menu" !== o || (jQuery.expr[":"].Contains = function (e, n, a) {
//                     return (e.textContent || e.innerText || "").toUpperCase().indexOf(a[3].toUpperCase()) >= 0
//                 }, i = a("#main-menu-navigation"), s = a(".menu-search"), a(s).change(function () {
//                     var e = a(this).val();
//                     if (e) {
...
//                     e.call(i),
//                 t.hasClass("vertical-layout") && (t.hasClass("menu-open") || t.hasClass("menu-expanded") ? (a(".menu-toggle").addClass("is-active"), "vertical-menu" !== t.data("menu") && "vertical-content-menu" !== t.data("menu") || a(".main-menu-header") && a(".main-menu-header").show()) : (a(".menu-toggle").removeClass("is-active"), "vertical-menu" !== t.data("menu") && "vertical-content-menu" !== t.data("menu") || a(".main-menu-header") && a(".main-menu-header").hide())),
//                     setTimeout(function () {
//                         n.call(i),
...
//             },
//             expand: function () {
//                 !1 === this.expanded && ("vertical-menu-modern" == t.data("menu") && (a(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-left").addClass("ft-toggle-right"), "undefined" != typeof Storage && localStorage.setItem("menuLocked", "true")), this.transit(function () {
...
//                     "vertical-menu" != t.data("menu") && "vertical-menu-modern" != t.data("menu") || !a(".main-menu").hasClass("menu-fixed") || a(".main-menu-content").css("height", a(e).height() - a(".header-navbar").height() - a(".main-menu-header").outerHeight() - a(".main-menu-footer").outerHeight())
//                 }))
//             },
//             collapse: function (n) {
//                 !1 === this.collapsed && ("vertical-menu-modern" == t.data("menu") && (a(".modern-nav-toggle").find(".toggle-icon").removeClass("ft-toggle-right").addClass("ft-toggle-left"), "undefined" != typeof Storage && localStorage.setItem("menuLocked", "false")), this.transit(function () {
...
//                     "vertical-menu-modern" == t.data("menu") && a(".main-menu").hasClass("menu-fixed") && this.manualScroller.enable()
//                 }))
//             },
...
//                 }), l.find("a").removeClass("dropdown-toggle"), l.find("a").removeClass("dropdown-item"), m.removeClass("dropdown").addClass("has-sub"), m.find("a").removeClass("dropdown-toggle nav-link"), m.children("ul").find("a").removeClass("dropdown-item"), m.find("ul").removeClass("dropdown-menu"), d.removeClass().addClass("has-sub"), a.app.nav.init(), a("ul.dropdown-menu [data-toggle=dropdown]").on("click", function (e) {
//                     e.preventDefault(),
//                         // e.stopPropagation(),
//                         a(this).parent().siblings().removeClass("open"),
//                         a(this).parent().toggleClass("open")
//                 })) : (t.removeClass("vertical-layout vertical-overlay-menu fixed-navbar").addClass(t.data("menu")), a("nav.header-navbar").removeClass("fixed-top"), n.removeClass().addClass(o), this.drillDownMenu(e), a("a.dropdown-item.nav-has-children").on("click", function () {
...
//                             if (n.hasClass("has-sub") || (i = n.find("span.menu-title").text(), s = n.children("a").attr("href"), "" !== i && ((l = a("<a>")).attr("href", s), l.attr("title", i), l.text(i), l.addClass("menu-title"))), o = n.css("border-top") ? n.position().top + parseInt(n.css("border-top"), 10) : n.position().top, "vertical-compact-menu" !== t.data("menu") && l.appendTo(".main-menu-content").css({
//                                 position: "fixed",
//                                 top: o
...
//                         // return false
//                         n.is(".disabled") ? undefined : t.hasClass("menu-collapsed")
//                         && "vertical-menu-modern" != t.data("menu")
//                         || "vertical-compact-menu" == t.data("menu")
//                         && n.is(".has-sub")
//                         && !t.hasClass("vertical-overlay-menu") ? undefined :
//                             n.has("ul") ? n.is(".open") ? n.trigger("close.app.menu") : n.trigger("open.app.menu") : n.is(".active")
//                                 || (n.siblings(".active").trigger("deactive.app.menu"), n.trigger("active.app.menu")), undefined
//                     }),
...
//                                 if (0 === a(".main-menu:hover").length && 0 === a(".navbar-header:hover").length && (a(".main-menu, .navbar-header").removeClass("expanded"), t.hasClass("menu-collapsed"))) {
...
//                             (t.hasClass("menu-collapsed") || "vertical-compact-menu" == t.data("menu")) && (a(".main-menu-content").children("span.menu-title").remove(), a(".main-menu-content").children("a.menu-title").remove(), a(".main-menu-content").children("ul.menu-content").remove()),
...
//                             else if (t.has("ul")) if (t.is(".open")) t.removeClass("open"),
//                                 e.collapse(t);
//                             else {
//                                 if (t.addClass("open"), e.expand(t), a(".main-menu").hasClass("menu-collapsible")) return !1;
//                                 t.siblings(".open").find("li.open").trigger("close.app.menu"),
...
//                     var n, s, o, l, r, m, d = e.children("ul:first"),
//                         u = d.clone(!0);
...
//                         l = o - n - e.height() - 30,
//                         m = a(".main-menu").hasClass("menu-dark") ? "light" : "dark",
//                         "vertical-compact-menu" === t.data("menu") ? (s = n + r, l = o - n - 30) : "vertical-content-menu" === t.data("menu") ? (s = n + e.height() + r, l = o - a(".content-header").height() - e.height() - n - 60) : s = n + e.height() + r,
//                         "vertical-content-menu" == t.data("menu") ? u.addClass("menu-popout").appendTo(".main-menu-content").css({
//                             top: s,
//                             position: "fixed"
//                         }) : (u.addClass("menu-popout").appendTo(".main-menu-content").css({
//                             top: s,
//                             position: "fixed",
//                             "max-height": l
